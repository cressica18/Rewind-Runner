...
export class Player {
    constructor(x, y) {
        ...
        Object.defineProperty(this, "coyoteTime", {
            enumerable: true,
            configurable: true,
            writable: true,
            value: 0
        });
        Object.defineProperty(this, "jumpBufferTime", {
            enumerable: true,
            configurable: true,
            writable: true,
            value: 0
        });
        Object.defineProperty(this, "wasOnGround", {
            enumerable: true,
            configurable: true,
            writable: true,
            value: false
        });
        Object.defineProperty(this, "trailTimer", {
            enumerable: true,
            configurable: true,
            writable: true,
            value: 0
        ...
        Object.defineProperty(this, "COYOTE_TIME", {
            enumerable: true,
            configurable: true,
            writable: true,
            value: 0.1
        });
        Object.defineProperty(this, "JUMP_BUFFER", {
            enumerable: true,
            configurable: true,
            writable: true,
            value: 0.12
        });
        Object.defineProperty(this, "ANIM_SPEED", {
            enumerable: true,
            configurable: true,
            writable: true,
            value: 0.08
    ...
    restoreState(s) {
        ...
        this.animTimer = s.animTimer;
        this.isDead = s.isDead;
        this.coyoteTime = s.coyoteTime;
        this.jumpBufferTime = s.jumpBufferTime;
    }
    update(dt, left, right, jumpPressed, jumpHeld, particles, audio) {
        if (this.isDead)
            return;
        if (jumpPressed)
    ...
    resolveCollisionY(platformY, platformFoot) {
