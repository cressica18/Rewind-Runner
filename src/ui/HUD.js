import { CANVAS_WIDTH, CANVAS_HEIGHT, PALETTE, lerp } from '../core/constants';
export class HUD {
    constructor() {
        Object.defineProperty(this, "rewindMeterAnim", {
            enumerable: true,
            configurable: true,
            writable: true,
            value: 1
        });
        Object.defineProperty(this, "rewindFlash", {
            enumerable: true,
            configurable: true,
            writable: true,
            value: 0
        });
        Object.defineProperty(this, "scoreAnim", {
            enumerable: true,
            configurable: true,
            writable: true,
            value: 0
        });
        Object.defineProperty(this, "lastScore", {
            enumerable: true,
            configurable: true,
            writable: true,
            value: 0
    ...
    update(dt, data) {
        ...
        if (data.isRewinding)
            this.rewindFlash = (this.rewindFlash + dt * 8) % (Math.PI * 2);
